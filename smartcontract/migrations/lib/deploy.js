...
const deployContractAndProxy = async (deployer, name, ContractImpl, ContractProxy, admin, initializer, types, values) => {
...
module.exports = { setWeb3, syncDeployInfo, deployContract, deployContractAndProxy, getProxyParam};
