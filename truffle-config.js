 ...
 */
 ...
 const mnemonicTest = "vessel purchase bone blush smoke salt jaguar tragic subject mercy immune dial";
...
module.exports = {
  ...
  networks: {
    ...
    bsctestnet: {
      provider: () => new HDWalletProvider(pvKey, `https://data-seed-prebsc-1-s1.binance.org:8545/`),
